...
const NewTask = ({ data, onMarkAccepted, index }) => {
  return (
    <div className="bg-[#393E46] shrink-0 h-[300px] w-[300px] rounded-3xl p-4 text-[#EEEEEE] flex flex-col justify-between">
      ...
      <div className="flex justify-center mt-4 h-12 items-center">
        <button
          onClick={() => onMarkAccepted(index)}
          className="bg-[#00ADB5] px-3 py-1 text-sm rounded-full w-full hover:opacity-90 transition"
        >
          Accept Task
        </button>
      </div>
